      ...
      <div className="header">
        <div className="navigation.pxy__30">
          <ul className="navbar d__flex">
            ...
            <a href="https://www.linkedin.com/in/anesu-muusha-6ab56b25b" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://github.com/AnesuMuusha" target="_blank" rel="noopener noreferrer">
              <li className="nav__items mx__15">
                {" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
